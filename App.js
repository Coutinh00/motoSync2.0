...
function MainTabs() {
  return (
    ...
    >
      <Tab.Screen name="Inicio" component={FleetScreen} options={{ headerShown: false }} />
      <Tab.Screen name="Frota" component={FleetScreen} options={{ headerShown: false }} />
